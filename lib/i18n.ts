...
type Dict = {
  ...
  profileQ: { name: string; age: string; gender: string; income: string; category: string; state: string; mode: string };
...
export const T: Record<Lang, Dict> = {
  en: {
    ...
    profileQ: { 
      name: "What is your name?", age: "How old are you?", gender: "What is your gender? Male, Female, or Other?", 
      income: "What is your monthly family income in rupees?", category: "What is your category? General, OBC, SC, or ST?",
      state: "Which state are you from?", mode: "What do you need help with? Say 'Schemes' to find benefits or 'Services' for help with government tasks."
    },
  ...
  hi: {
    ...
    profileQ: { 
      name: "आपका नाम क्या है?", age: "आपकी उम्र कितनी है?", gender: "आपका लिंग क्या है? पुरुष, महिला, या अन्य?", 
      income: "आपकी मासिक पारिवारिक आय कितनी है?", category: "आपकी श्रेणी क्या है? सामान्य, OBC, SC, या ST?",
      state: "आप किस राज्य से हैं?", mode: "आपको क्या चाहिए? योजनाओं के लिए 'योजना' बोलें और सेवाओं के लिए 'सेवा'।"
    },
  ...
  mr: {
    ...
    profileQ: { 
      name: "तुमचे नाव काय आहे?", age: "तुमचे वय किती आहे?", gender: "तुमचे लिंग काय आहे? पुरुष, स्त्री, किंवा इतर?", 
      income: "तुमचे मासिक कौटुंबिक उत्पन्न किती आहे?", category: "तुमचा प्रवर्ग काय आहे? सामान्य, OBC, SC, किंवा ST?",
      state: "तुम्ही कोणत्या राज्यातील आहात?", mode: "तुम्हाला काय हवे आहे? योजना शोधण्यासाठी 'योजना' म्हणा आणि सेवांसाठी 'सेवा'।"
    },
  ...
  gu: {
    ...
    profileQ: { 
      name: "તમારું નામ શું છે?", age: "તમારી ઉંમર કેટલી છે?", gender: "તમારી જાતિ શું છે? પુરુષ, સ્ત્રી, કે અન્ય?", 
      income: "તમારી માસિક પારિવારિક આવક કેટલી છે?", category: "તમારી શ્રેણી શું છે? સામાન્ય, OBC, SC, કે ST?",
      state: "તમે કયા રાજ્યના છો?", mode: "તમારે શું જોઈએ છે? યોજનાઓ માટે 'યોજના' કહો અને સેવાઓ માટે 'સેવા' કહો."
    },
