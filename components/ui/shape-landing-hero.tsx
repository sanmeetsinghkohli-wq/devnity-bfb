...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-slate-50 text-slate-900">
            ...
            <div className="relative z-10 mx-auto px-4 md:px-6 w-full max-w-7xl pt-10 pb-20">
                <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
                    ...
                    >
                        <h1 className="text-5xl sm:text-7xl md:text-[5.5rem] font-bold tracking-tight leading-[1.1]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-50 via-transparent to-slate-50/40 pointer-events-none" />
        </div>
    );
}
